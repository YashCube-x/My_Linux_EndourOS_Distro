...
PanelWindow {
    ...
    Process {
        id: pGetApps
        command: ["python3", "/home/suyash/.config/quickshell/get_apps.py"]
        stdout: SplitParser {
                ...
                TextField {
                    ...
                    Keys.onReturnPressed: {
                        if (listView.currentIndex >= 0 && listView.currentIndex < appModel.count) {
                            ...
                            pExec.running = false;
                            pExec.command = ["/home/suyash/.config/quickshell/launch_app.sh", app.cmd];
                            pExec.running = true;
                            show = false;
                        }
                    }
                    ...
                    delegate: Rectangle {
                        ...
                        MouseArea {
                            ...
                            onClicked: {
                                ...
                                pExec.running = false;
                                pExec.command = ["/home/suyash/.config/quickshell/launch_app.sh", model.cmd];
                                pExec.running = true;
