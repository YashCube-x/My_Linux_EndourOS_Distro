...
ShellRoot {
    ...
    property color colBg: "#12141d"
    property color colFg: "#c5cadd"
    property color colAccent: "#8ea3c9"
    property color colMuted: "#7a8296"
    property color colHover: "#343a4d"
    property color colCrit: "#e88388"
    ...
    Process {
        command: ["/home/suyash/.config/quickshell/count_tiled.sh"]
        running: true
        stdout: SplitParser {
            onRead: data => {
    ...
    Process {
        ...
        command: ["sh", "-c", "grep -q '^#animations' /home/suyash/.config/hypr/modules/look_and_feel.conf && echo 'false' || echo 'true'"]
        running: true
        stdout: SplitParser { onRead: data => { root.batteryMode = (data.trim() === 'true'); } }
    }
    Process {
        id: pToggleBatteryMode
        command: ["/home/suyash/.config/quickshell/toggle_bar.sh"]
    }
    ...
    Process { id: pNoteHyprland; command: ["kitty", "-e", "nvim", "/home/suyash/.config/hypr"] }
    Process { id: pNoteWaybar; command: ["kitty", "-e", "nvim", "/home/suyash/.config/waybar/"] }
    Process { id: pNoteTofi; command: ["kitty", "-e", "nvim", "/home/suyash/.config/tofi/"] }
    Process { id: pNoteKitty; command: ["kitty", "-e", "nvim", "/home/suyash/.config/kitty"] }
    Process { id: pNoteFoot; command: ["kitty", "-e", "nvim", "/home/suyash/.config/foot"] }
    Process { id: pNoteGhostty; command: ["kitty", "-e", "nvim", "/home/suyash/.config/ghostty"] }
    Process { id: pNoteFish; command: ["kitty", "-e", "nvim", "/home/suyash/.config/fish"] }
    Process { id: pNoteFastfetch; command: ["kitty", "-e", "nvim", "/home/suyash/.config/fastfetch"] }
    Process { id: pNoteQuickshell; command: ["kitty", "-e", "nvim", "/home/suyash/.config/quickshell"] }
        ...
        RowLayout {
            ...
            Mod { 
                ...
                textColor: {
                    ...
                    if (isWarn) return "#dbb27a";
                    if (root.batteryCharging) return "#8ec9a3";
                    return root.colFg;
                }
                bgColor: "transparent"
                blink: isCrit
            ...
            Mod {
                ...
                textColor: root.stopwatchRunning ? "#dbb27a" : root.colFg
                bgColor: "transparent"
            ...
            Mod {
                ...
                textColor: root.timerRunning ? "#dbb27a" : root.colFg
                bgColor: "transparent"
                show: isActive && !controlCenter.show && !root.showOsd
                onClicked: controlCenter.show = true
            }
            ...
            Mod {
                ...
                textColor: root.batteryMode ? "#dbb27a" : "#8ec9a3"
                bgColor: "transparent"
            ...
            Mod {
                text: ""
                textColor: root.micMuted ? root.colMuted : "#dbb27a"
                bgColor: "transparent"
    ...
    component ModernBatteryIcon: Item {
        ...
        Rectangle {
            ...
            Rectangle {
                ...
                radius: 2
                color: {
                    if (battIcon.charging) return "#8ec9a3";
                    if (battIcon.level <= 0.2) return "#e88388";
        ...
        RowLayout {
            ...
            Rectangle {
                ...
                Text {
                    anchors.centerIn: parent
                    text: mbtn.iconText
                    color: mbtn.isActive ? "#c5cadd" : root.colFg
    ...
    component ModernSlider: Slider {
        ...
        handle: Rectangle {
            ...
            implicitHeight: 16
            radius: 8
            color: mSlider.pressed ? Qt.rgba(0.8, 0.8, 0.8, 1) : "#c5cadd"
                ...
                Item {
                            ...
                            RowLayout {
                                ...
                                Text { 
                                    ...
                                    color: {
                                        ...
                                        return isCrit ? root.colCrit : (isWarn ? "#dbb27a" : (root.batteryCharging ? "#8ec9a3" : root.colFg));
                                    }
                                    font.family: root.fontFamily
                                    font.pixelSize: 18 
                                }
                    ...
                    RowLayout {
                        ...
                        ModernButton {
                            ...
                            accent: root.pomodoroState === 1 ? "#e88388" : "#8ec9a3"
                            onClicked: {
